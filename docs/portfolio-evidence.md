...
| 2.24 | **Fixed-consumption price comparison**: the 27 ToU households' 456,096 charged 2013 readings priced at the documented flat rate (A2) come to £12,160.26 against £11,675.43 under the dynamic schedule (A1) — dynamic 4.0% lower; 25 of 27 households lower (+0.9% to +11.4%), 2 higher; identical on the Python and certified-dbt routes. Not a bill or a saving; A2 assumes an UNKNOWN period. | ANL-005, `uv run compare-flat-price` | **VERIFIED** (this sample) |
| 2.23 | **Whole zero days arrive in runs**: 963 of 61,799 usable days across the three loaded files total exactly zero, in 5 of 83 households and 52 runs (13 of 28+ days); 38 of 52 runs have a non-zero usable day on both sides (measured), none touches a recorded span. Cause UNKNOWN and not inferred. Reconciles with FORE-001's 975 (963 usable + 12 unusable zero-total days) | ANL-004, `uv run zero-day-runs` | **VERIFIED** (this warehouse) |
