...
| 2.23 | **Whole zero days arrive in runs**: 963 of 61,799 usable days across the three loaded files total exactly zero, in 5 of 83 households and 52 runs (13 of 28+ days); 50 of 52 runs are interior to the loaded data. Cause UNKNOWN and not inferred. Reconciles with FORE-001's 975 (963 usable + 12 unusable zero-total days) | ANL-004, `uv run zero-day-runs` | **VERIFIED** (this warehouse) |
