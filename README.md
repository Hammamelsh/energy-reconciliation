...
![The front door's opening view. Eyebrow: "2013 Low Carbon London trial". Heading: "Same electricity use, priced two ways. A £484.83 difference." An explanation: 456,096 readings from 27 households were kept unchanged and the total was calculated twice, once using the trial's published Low, Normal and High prices and once using its flat price of 14.228p per kWh throughout. The result "Dynamic pricing came out 4.0% lower overall", the line "£11,675.43 compared with £12,160.26. It came out lower for 25 households and higher for 2.", two bars comparing the totals, 27 household marks (25 lime, 2 orange), the action "Why did 2 come out higher?", and the line "Historical comparison, not a current tariff recommendation or a complete bill."](docs/images/front-door-landing.png)

*The public front door ([`web/`](web/)): a static page over a 60 kB data file exported from the published version and checked against its pinned SHA-256 digest in the browser before anything is shown. Deployed at [energy-reconciliation.onrender.com](https://energy-reconciliation.onrender.com/); this image is the opening view at this version, kept here as a fallback.*
